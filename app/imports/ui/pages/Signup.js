...
var Signup = /** @class */ (function (_super) {
    ...
    Signup.prototype.handleChange = function (e, _a) {
        var name = _a.name, value = _a.value;
        var _b;
        this.setState((_b = {}, _b[name] = value, _b));
    };
    /** Handle Signup submission using Meteor's account mechanism. */
    Signup.prototype.handleSubmit = function () {
        var _this = this;
        var _a = this.state, email = _a.email, password = _a.password;
        accounts_base_1.Accounts.createUser({ email: email, username: email, password: password }, function (err) {
            if (err) {
        ...
        return (React.createElement(semantic_ui_react_1.Container, null,
            React.createElement(semantic_ui_react_1.Grid, { textAlign: "center", verticalAlign: "middle", centered: true, columns: 2 },
                React.createElement(semantic_ui_react_1.Grid.Column, null,
                    ...
                    this.state.error === '' ? ('') : (React.createElement(semantic_ui_react_1.Message, { error: true, header: "Registration was not successful", content: this.state.error }))))));
    };
    return Signup;
}(React.Component));
