...
var Signin = /** @class */ (function (_super) {
    ...
    Signin.prototype.handleChange = function (e, _a) {
        ...
        return (React.createElement(semantic_ui_react_1.Container, null,
            React.createElement(semantic_ui_react_1.Grid, { textAlign: "center", verticalAlign: "middle", centered: true, columns: 2 },
                React.createElement(semantic_ui_react_1.Grid.Column, null,
                    ...
                    this.state.error === '' ? ('') : (React.createElement(semantic_ui_react_1.Message, { error: true, header: "Login was not successful", content: this.state.error }))))));
    };
    return Signin;
}(React.Component));
